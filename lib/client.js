  ...
  function ComposerAgentSelector(props) {
    ...
    return React.createElement("div", { ref: rootRef, style: { position: "relative", display: "inline-flex" } },
      ...
      d.open ? React.createElement("div", {
        ...
        React.createElement("div", { style: { fontSize: 11, color: "#8b949e", padding: "2px 8px 4px" } }, "⚡ 委派模式（点选即生效）"),
        [
          { mode: 0, title: "OFF · 关闭", desc: "常规行为：任务由当前对话直接处理" },
          { mode: 1, title: "ON · 任务类自动委派", desc: "任务类指令自动交给所选智能体；寒暄提问仍直答" },
          { mode: 2, title: "FULL · 全托管", desc: "所有消息（含讨论、追问）一律交给所选智能体；会话记忆自动携带" },
        ].map(function (opt) {
